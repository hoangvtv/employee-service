package com.phamtanhoang.employeeservice.query.projection;


import com.phamtanhoang.employeeservice.command.data.Employee;
import com.phamtanhoang.employeeservice.command.data.EmployeeRepository;
